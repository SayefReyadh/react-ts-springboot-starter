 ...
 * 
 * Provides information about modern Spring Boot alternatives to raw TCP sockets:
...
public class SocketExamplesController {
    ...
    public Map<String, Object> getQuickStart() {
        ...
        steps.add(Map.of(
            ...
            "curl", "curl -X POST http://localhost:8080/api/websocket/broadcast -H 'Content-Type: application/json' -d '{\"message\":\"Hello\"}'"
        ));
