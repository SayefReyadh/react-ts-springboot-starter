...
function Navigation() {
  ...
  return (
    <nav style={navStyle}>
      ...
      <Link to="/websocket" style={linkStyle('/websocket')}>🔌 WebSocket</Link>
      <Link to="/sse" style={linkStyle('/sse')}>📡 SSE</Link>
      <Link to="/async" style={linkStyle('/async')}>⚡ Async/Threading</Link>
    </nav>
  )
}
